...
validgen = train_generator.flow_from_directory(DATA_DIR/'train', target_size=(224, 224),
                                               class_mode='categorical',
                                               classes=classes,
                                               subset='validation',
                                               batch_size=BATCH_SIZE,
...
resnet_acc = accuracy_score(true_classes, predIdxs)
print("VGG16 Model Accuracy with Fine-Tuning: {:.2f}%".format(resnet_acc * 100))

print("[INFO] saving model...")
model.save(MODEL_PATH, save_format="densenetnet5")
