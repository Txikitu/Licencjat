...
class DenseNet:
    ...
    def build_model(self):
        ...
        x, nb_channels = self.dense_block(x, self.dense_layers[-1], nb_channels,
                                          self.growth_rate, self.dropout_rate, self.bottleneck)
...
densenet = DenseNet(input_shape=[256, 256, 3], nb_classes=6, dropout_rate=0.2, bottleneck=True)
model_densenet = densenet.build_model()


model_densenet.compile(optimizer='Adadelta',
